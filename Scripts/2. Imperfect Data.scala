// /opt/spark-2.4.0/bin/spark-shell --packages djgarcia:NoiseFramework:1.2,djgarcia:RandomNoise:1.0,djgarcia:SmartFiltering:1.0,JMailloH:Smart_Imputation:1.0,JMailloH:kNN_IS:3.0
...
val pathTrain = "file:///home/USER/datasets/susy-10k-tra.data"
val rawDataTrain = sc.textFile(pathTrain)

val pathTest = "file:///home/USER/datasets/susy-10k-tst.data"
